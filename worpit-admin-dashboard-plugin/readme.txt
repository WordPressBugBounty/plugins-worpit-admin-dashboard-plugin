...
* **IMPROVED**:	WorpDrive client handling has been improved to deliver more reliable database exports, with better handling across a wider range of hosting environments and database setups.

= 5.5 Series =
*Released: 8th April 2025*

* **(.4)  SECURITY**:	Address security vulnerability by tightening the site-pairing process. A new "Start Pairing" step required.
* **(.3)  IMPROVED**:	Disk space check limited to 1MB, by default.
...
* **(.4)  FIXED**:		Fix DB export edge-case for DB tables with a single row, with unique ID 0.
...
* **(.4)  IMPROVED**:	Add ZipArchive fallback to PclZip.
* **(.4)  IMPROVED**:	Don't completely fail archive when individual files are not readable.
...
* **(.1)  IMPROVED**:	Improved support for large SearchWP databases.
* **(.0)  IMPROVED**:	Added support for streaming data exports where hosts prevent direct requests for ZIP files.
* **(.0)  IMPROVED**:	Add further security around action requests.
* **(.0)  IMPROVED**:	Code cleaning and optimisations.

= 5.1 Series =
*Released: March 2025*

* **(.3)  FIXED**:		Some fixes and improvements to file mapping logic.
* **(.3)  IMPROVED**:	Improved support for multisite db table exports.
* **(.2)  IMPROVED**:	Improvements to rapid DB exports for larger DB tables.
...
* **(.0)  IMPROVED**:	Compatibility with the latest version of [Shield Security](https://wordpress.org/plugins/wp-simple-firewall/).
